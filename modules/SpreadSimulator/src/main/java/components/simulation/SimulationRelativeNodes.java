...
public class SimulationRelativeNodes extends Simulation {

    public SimulationRelativeNodes(Graph graph, SimulationModel simulationModel) {
    ...
    public void Step() {
        ...
        for (int i = 0; (double) i / selectedNodes.size() < interaction.getPercentage(); i+=2) {
