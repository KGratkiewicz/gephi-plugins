 ...
 */
public class WeightedCommonNeighbors implements Statistics, LongTask {
    private Boolean cancel = false;
    private ProgressTicket progressTicket;
    private double value = 0.0;
    private boolean isDirected = false;
    private final String statisticColName = "WCN";
    ...
    public void execute(Graph graph) {
        ...
        value = weightedCommonNeighborsIndirect(graph, isDirected, cancel, progressTicket, statisticColName);
